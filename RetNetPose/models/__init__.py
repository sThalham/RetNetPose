...
def assert_training_model(model):
    ...
    assert (all(output in model.output_names for output in ['bbox', '3Dbox', 'cls', 'feat'])), "Input is not a training model (no 'regression' and 'classification' outputs were found, outputs are: {}).".format(model.output_names)
